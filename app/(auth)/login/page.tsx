...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 px-4">
      ...
      <div
        className="w-full max-w-md rounded-2xl bg-zinc-900 border border-cyan-500/[0.27] p-8 shadow-[0_0_0_1px_rgba(34,211,238,0.13),0_0_20px_rgba(34,211,238,0.13),0_0_40px_rgba(34,211,238,0.05)]"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div style={{ animation: "fadeUp 400ms cubic-bezier(0.16,1,0.3,1) 300ms both" }}>
            ...
            <input
              ...
              className="block w-full rounded-lg border border-cyan-500/[0.27] bg-zinc-800 px-3 py-2 pr-10 text-sm text-white placeholder:text-zinc-600 focus:border-cyan-500/[0.4] focus:outline-none shadow-[0_0_0_1px_rgba(34,211,238,0.13),0_0_12px_rgba(34,211,238,0.08)] focus:shadow-[0_0_0_1px_rgba(34,211,238,0.27),0_0_20px_rgba(34,211,238,0.16)]"
            />
            <button
              type="button"
